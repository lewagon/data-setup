...
CONSTANTS = {
    ...
    'BOOTCAMP_COMPLETE_REQUIREMENTS' => "yapf pylint jupyterlab seaborn plotly nbconvert xgboost statsmodels pandas-profiling dtale jupyter-resource-usage jupyter_contrib_nbextensions",
